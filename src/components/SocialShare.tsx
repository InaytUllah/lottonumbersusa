  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <button
        id="copy-btn"
        onClick={handleCopy}
        className="h-8 px-3 rounded-full bg-gray-100 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
      >
        Copy Link
      </button>
